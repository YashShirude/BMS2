        ...
        try{
            ...
            if(aadharField.getText().isEmpty() || panField.getText().isEmpty() || initialField.getText().isEmpty() || accType == null || pin == null){
                ...
                if(accType.equals("Saving")){
                    String q2 = "insert into transaction values('"+accNo+"','"+accType+"','"+s.totalTransactions()+"','"+s.totalOverdraft()+"','"+currentDateTime+"')";
                    c2.s.executeUpdate(q2);
                }else{
                    String q2 = "insert into transaction values('"+accNo+"','"+accType+"','"+c.totalTransactions()+"','"+c.totalOverdraft()+"','"+currentDateTime+"')";
                    c2.s.executeUpdate(q2);
                }
                new SqlQuery(accNo);
