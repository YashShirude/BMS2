...
public class TransferFunds extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == backButton){
        ...
        } else if(ae.getSource() == confirmButton && (accField.getText().isEmpty() || amtField.getText().isEmpty() || pin.isEmpty())){
            ...
            if(accField.getText().isEmpty() || amtField.getText().isEmpty() || pin.isEmpty()){
                ...
                status = false;
            } else if(senderBalanceInt < amountInt && remOverdraft < amountInt){
                amtField.setText("");
                pinField.setText("");
