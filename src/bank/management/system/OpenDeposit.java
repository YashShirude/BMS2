        ...
        if(ae.getSource() == confirmButton){
            if(pin.equals(SqlQuery.pin)){
                if(SqlQuery.balance > principal){
                    ...
                    try{
                        Conn c1 = new Conn();
                        String q6 = "insert into deposit values('"+SqlQuery.accNo+"','"+deposit+"','"+principal+"','"+AbstractAccount.rate+"','"+tenure+"','"+interest+"','"+currentDateTime+"')";
